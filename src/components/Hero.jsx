  ...
  <section className="relative overflow-hidden bg-black">
    ...
    <div className="relative mx-auto max-w-7xl px-6 pt-24 pb-20">
      ...
      <p className="glow-paragraph mt-8 max-w-2xl mx-auto text-center text-base sm:text-lg">
        ...
        visualization, gamified challenges and AI‑assisted optimization—all in one browser lab.
      </p>
      ...
      <div className="mt-24">
        <div className="relative mx-auto max-w-5xl rounded-[48px] overflow-hidden aspect-[16/7] ring-1 ring-white/10 shadow-2xl">
          ...
          <div className="absolute bottom-6 left-8 text-xs text-gray-300 font-mono bg-black/40 px-3 py-1.5 rounded-full border border-white/10">
            preview: scheduler · memory · deadlock graph
          </div>
        </div>
      </div>
    </div>
