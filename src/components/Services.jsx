...
const modules = [
  {
    ...
    to: '/process-memory',
    desc: 'Scheduling (FCFS, SJF, Priority, RR, MLQ) + allocation (First / Best / Worst Fit) with live Gantt & memory map.',
  ...
  },
  {
    ...
    to: '/shell-kernel',
    desc: 'User commands, future system call & privilege simulation.',
    icon: <IconBolt className="w-6 h-6" />
  },
  {
    title: 'Security & Access Control',
    to: '/security',
    desc: 'Role / sudo model, authorization & audit log (planned).',
    icon: <IconShield className="w-6 h-6" />
  },
  {
    title: 'Visualization & Reporting',
    to: '/visualization',
    desc: 'Gantt, memory map, metrics export (CSV/PDF planned).',
